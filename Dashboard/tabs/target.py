        ...
        [
            ...
            dcc.Graph(
                ...
                figure = px.bar(
                    ...
                    y=HS.index, 
                    orientation='h', 
                    title='Music Streaming by Household Income', 
            ...
            [
                dcc.Graph(
                    ...
                    figure = px.choropleth(
                        ...
                        title = 'Household Music Streaming by State'
                    ),
                    style={
                        'padding':'0.8rem', 'marginTop':'1rem', 'marginLeft':'1rem', 'boxShadow': '#e3e3e3 2px 2px 1px', 
                        'border-radius': '10px', 'backgroundColor': 'White','width':'100%'
                ...
                [
                    dcc.Graph(
                        ...
                        figure= px.bar(
                            x=IS.index, 
                            y=IS.values, 
                            title='Music Streaming by Home Internet Connection', 
                    ...
                    dcc.Graph(
                        id='employment-streaming', 
                        figure = px.bar(
                            y=ES.values, 
                            x=ES.index, 
                            title='Music Streaming by Employment Status',
